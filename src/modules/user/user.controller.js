...
userController.post("/update-password", auth, multer_cloud({ allowedType: extinstions.image }).single("image"), async (req, res) => {

    const data = await userServices.UpdatePasswordServices(req)
